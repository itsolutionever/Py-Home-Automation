...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="index.php">Py-Home-Automation</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				...
				if($_SESSION["login_type"] == "admin"){?>
					<li class="label-success">
						<a class="page-scroll" href="index.php?page=admin">Admin</a>
					</li>
				<?php }
				elseif($_SESSION["login_type"] == "user"){?>
					<li class="label-success">
						<a class="page-scroll" href="index.php?page=user">User</a>
				    </li>
				<?php }?> 
                    <li>
