...
<table>
	...
	<div class="form-group">
			<tr>
			<td><label for="email" style="margin:0px; padding:0px; font-size:13px;">Email Address</label></td>
			</tr>
			<tr>
			<td><input type="email" class="form-control-center" id="email" name="email" size="30%" value="<?php echo$email?>" disabled/><br><br></td>
			</tr>
	</div>
	<div class="form-group">
			<tr>
			<td><label for="password" style="margin:0px; padding:0px; font-size:13px;">Enter New Password (required)</label></td>
			</tr>
			<tr>
			<td><input type="text" class="form-control-center" id="password" name="password" size="30%" value=""/><br><br></td>
			</tr>
	</div>
	<div class="form-group">
			<tr>
